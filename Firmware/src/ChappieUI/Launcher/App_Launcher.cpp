...
namespace App {
    ...
    void App_Launcher::time_update(lv_timer_t * timer)
    {
        ...
        lv_label_set_text(ui_LabelHomeDate, date_buffer);
    ...
    void App_Launcher::panel_control_pad_event_cb(lv_event_t * e)
    {
        ...
        /* If enable auto screen off */
            ...
            printf("device status auto screeoff: %d\n", _device_status.autoScreenOff);
        }

        /*if enable wifi button*/
